...
$("#likeBtn").on('click', function() {
  ...
  // $.ajax({
      //   url: "localhost:5000/products/likes", 
      //   method: "GET"
      // })
...
// if (results.length === 0) {
//   $(".liked-container").append("<a>").text("You have no items to display.")  
// }
// for (i = 0; i < results.length; i++) {
//   var prod_name = $("<h2>").text(results.product_name);

//   var divA = $("<div>");
//   divA.addClass("prodName");

//   $(".liked-container").append(divA);
// }
